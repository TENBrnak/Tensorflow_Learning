...
BATCH_SIZE = 32
train_dataset = test_dataset.cache().repeat().shuffle(num_train_examples).batch(BATCH_SIZE)
...
def plot_image(i, predictions_array, true_labels, images):
    ...
    matplotlib.pyplot.imshow(img[..., 0], cmap=matplotlib.pyplot.cm.binary)
...
def plot_value_array(i, predictions_array, true_label):
    ...
    matplotlib.pyplot.xticks([])
    matplotlib.pyplot.yticks([])
    thisplot = matplotlib.pyplot.bar(range(10), predictions_array, color="#777777")
...
matplotlib.pyplot.savefig("./hello.png")
